...
Invoke-WebRequest -uri "https://wdgoii.github.io/ps/eventos.ps1" -OutFile .\eventos.ps1
...
Invoke-WebRequest -uri "https://wdgoii.github.io/ps/informacoes.txt" -OutFile .\informacoes.txt
...
Invoke-WebRequest -uri "https://wdgoii.github.io/ps/install-winget.txt" -OutFile .\install-winget.txt
